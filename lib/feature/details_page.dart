  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          openMap(
              latitude: widget.restaurant.latlng.lat,
              longitude: widget.restaurant.latlng.lng);
        },
                  ...
                  Row(
                    children: [
                      Icon(Icons.fastfood_outlined,
                          size: w * 0.05, color: ColorTheme.Greydark),
                      SizedBox(
                        width: w * 0.02,
                      ),
                      Text(
                        ...
                        style: TextStyle(
                            fontWeight: FontWeight.w400, fontSize: w * 0.040),
                      )
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownButton(
                          ...
                          isExpanded: true,
                          hint: Text(
                            widget.restaurant.operatingHours.monday,
                            style: TextStyle(
                                fontWeight: FontWeight.w400,
                                fontSize: w * 0.040,
                                color: ColorTheme.black87),
